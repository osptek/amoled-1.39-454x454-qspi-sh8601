...
static const char *TAG = "sh8601_spi";
...
static esp_err_t sh8601_spi_apply_brightness(void *driver_data, uint8_t brightness_percent);
...
esp_err_t esp_lcd_new_panel_sh8601_spi(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config, esp_lcd_panel_handle_t *ret_panel)
{
    ...
    sh8601->panel_ctx.apply_brightness = sh8601_spi_apply_brightness;
    sh8601->base.user_data = &sh8601->panel_ctx;
...
static esp_err_t sh8601_spi_apply_brightness(void *driver_data, uint8_t brightness_percent)
{
    ...
    ESP_RETURN_ON_ERROR(tx_param(sh8601, io, 0x51, (uint8_t[]) {
        hw_brightness
